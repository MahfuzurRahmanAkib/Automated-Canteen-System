...
public class AvailableFoodListAdapter extends RecyclerView.Adapter<AvailableFoodListAdapter.MyViewHolder> {

    ArrayList<AvailableFoodModel> a_f_List;
    Context context;

    public AvailableFoodListAdapter(Context context,ArrayList<AvailableFoodModel> a_f_List) {
